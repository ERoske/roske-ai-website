---
title: "How I Built the AI Hub Heatmaps"
description: "I pulled raw BLS and OpenAlex data myself instead of citing the citation chain. Here is how, what I found, and where the methodology has limits."
date: 2026-05-06
...
I'm a data scientist by training, and one of the things I miss in the CEO chair is doing the actual analysis. This was an excuse to keep those muscles warm: pandas, plotly, a couple of public APIs, and a Saturday. Two heatmaps came out of it, one for the United States and one for the world. Here is how I built them, what I found, and where the methodology has limits. Everything is in a [public repo](https://github.com/ERoske/where-is-ai) so you can check my work.

## The U.S. heatmap: BLS, the boring source nobody uses

![U.S. heatmap of AI workers by metropolitan area, May 2025 OEWS release. Warner Robins, Georgia stands out as the new #1 metro by AI concentration per 1,000 workers, with the Bay Area, Seattle, and the Washington DC corridor showing as the densest large-metro clusters.](/images/blog/how-i-built-the-ai-hub-heatmaps/heatmap-usa-may-2025.png)
...
![World heatmap of AI research output by metro, May 2025 to May 2026 from OpenAlex. Beijing leads at 42,843 papers, Hong Kong jumps to fourth once districts are aggregated, and the Bay Area appears as one metro after rolling Stanford, Berkeley, Mountain View, San Francisco, and San Jose together.](/images/blog/how-i-built-the-ai-hub-heatmaps/heatmap-world.png)

[OpenAlex](https://openalex.org) indexes 250 million scholarly works with structured metadata about authors, affiliations, and concepts. It is free. It has an API. It is one of the most underutilized data sources in commercial AI commentary.
...
If you want to extend the analysis, the obvious next layers are AI startup funding by metro ([Crunchbase](https://www.crunchbase.com) covers it), AI patent filings ([USPTO](https://www.uspto.gov) and [WIPO](https://www.wipo.int) have free data), and GPU compute capacity by region (more sensitive, harder to source). I will probably do those next.
