...
export const currentTheme: ThemeConfig = {
  ...
  hero: {
    title: "ROSKE.AI",
    subtitle: "Ten species of working software, an eleventh that pays for nothing, and notes on which ones bite.",
    description: "Everybody selling you AI has 10 slides about agents. I have 10 agents, one per project. They run my calendar and my inbox, plan every trip I take, produce the podcast, build a video episode before I wake up, recruit speakers for a conference in October, pitch me for stages, and rebuild this entire website every Saturday at 5 AM while I'm asleep. So I did what a naturalist does with anything he's watched for 3 years and I wrote the guide: Latin names, habitat, range, feeding behavior, and honest field notes, including the specimen that ate 3 days of work and the parts of my day where nothing lives at all.",
